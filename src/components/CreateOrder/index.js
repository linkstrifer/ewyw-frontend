...
export default function CreateOrder({foods}){
  ...
  const totalPrice = !!products && products.length > 0 &&
    products.map((product) => product.selectedType && product.types.find((el) => el.foodLabel === product.selectedType).foodPrice * product.quantity).reduce(reducer)
            ...
            <>
              ...
              <label>
                ...
                >
                  ...
                  {foods
                    .filter(({foodCategory}) => foodCategory === selectCategory)
                    .map(({foodName}) => (
              ...
              <div>
                Costo total:{totalPrice ? totalPrice : 0 }
              </div>
